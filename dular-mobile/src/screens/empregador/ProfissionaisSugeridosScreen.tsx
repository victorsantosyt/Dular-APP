  ...
  if (!cidade || !uf) {
    content = (
      <View style={s.contentPadding}>
        <DEmptyState
          icon="MapPin"
          title="Defina sua região para ver sugestões"
          subtitle="Informe sua localização atual para encontrarmos profissionais próximos de você."
    ...
    content = (
      <View style={s.contentPadding}>
        <DSkeletonCard count={4} height={96} />
      </View>
    );
  } else if (error) {
    content = (
    ...
    content = (
      <View style={s.contentPadding}>
        <DEmptyState
          icon="Sparkles"
          title="Nenhum profissional sugerido"
          subtitle="Ainda não há profissionais ativos na sua região. Volte mais tarde."
        />
      </View>
    );
  } else {
...
export default ProfissionaisSugeridosScreen;
